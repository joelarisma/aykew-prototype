...
*/
(function(r,n,m){var w=function(d,u){function v(a){a=a.context[0];return a.oInit.editor||a._editor}function x(a,b,c,d){b||(b={});b.buttons===m&&(b.buttons="_basic");b.title===m&&(b.title=a.i18n[c].title);b.message===m&&("remove"===c?(a=a.i18n[c].confirm,b.message=1!==d?a._.replace(/%d/,d):a["1"]):b.message="");return b}if(!u||!u.versionCheck("1.10"))throw"Editor requires DataTables 1.10 or newer";var e=function(a){!this instanceof e&&alert("DataTables Editor must be initialised as a 'new' instance'");
this._constructor(a)};u.Editor=e;d.fn.DataTable.Editor=e;var q=function(a,b){b===m&&(b=n);return d('*[data-dte-e="'+a+'"]',b)},w=0;e.Field=function(a,b,c){var k=this,a=d.extend(!0,{},e.Field.defaults,a);this.s=d.extend({},e.Field.settings,{type:e.fieldTypes[a.type],name:a.name,classes:b,host:c,opts:a});a.id||(a.id="DTE_Field_"+a.name);a.dataProp&&(a.data=a.dataProp);a.data||(a.data=a.name);var h=u.ext.oApi;this.valFromData=function(b){return h._fnGetObjectDataFn(a.data)(b,"editor")};this.valToData=
...
'">'+a.fieldInfo+"</div></div></div>");c=this._typeFn("create",a);null!==c?q("input",b).prepend(c):b.css("display","none");this.dom=d.extend(!0,{},e.Field.models.dom,{container:b,label:q("label",b),fieldInfo:q("msg-info",b),labelInfo:q("msg-label",b),fieldError:q("msg-error",b),fieldMessage:q("msg-message",b)});d.each(this.s.type,function(a,b){typeof b==="function"&&k[a]===m&&(k[a]=function(){var b=Array.prototype.slice.call(arguments);b.unshift(a);var c=k._typeFn.apply(k,b);console.log(a,b,c);return c===
m?k:c})})};e.Field.prototype={dataSrc:function(){return this.s.opts.data},valFromData:null,valToData:null,destroy:function(){this.dom.container.remove();this._typeFn("destroy");return this},def:function(a){var b=this.s.opts;if(a===m)return a=b["default"]!==m?b["default"]:b.def,d.isFunction(a)?a():a;b.def=a;return this},disable:function(){this._typeFn("disable");return this},enable:function(){this._typeFn("enable");return this},error:function(a,b){var c=this.s.classes;a?this.dom.container.addClass(c.error):
this.dom.container.removeClass(c.error);return this._msg(this.dom.fieldError,a,b)},inError:function(){return this.dom.container.hasClass(this.s.classes.error)},focus:function(){this.s.type.focus?this._typeFn("focus"):d("input, select, textarea",this.dom.container).focus();return this},get:function(){var a=this._typeFn("get");return a!==m?a:this.def()},hide:function(a){var b=this.dom.container;a===m&&(a=!0);b.is(":visible")&&a?b.slideUp():b.css("display","none");return this},label:function(a){var b=
this.dom.label;if(!a)return b.html();b.html(a);return this},message:function(a,b){return this._msg(this.dom.fieldMessage,a,b)},name:function(){return this.s.opts.name},node:function(){return this.dom.container[0]},set:function(a){return this._typeFn("set",a)},show:function(a){var b=this.dom.container;a===m&&(a=!0);!b.is(":visible")&&a?b.slideDown():b.css("display","block");return this},val:function(a){return a===m?this.get():this.set(a)},_errorNode:function(){return this.dom.fieldError},_msg:function(a,
b,c){a.parent().is(":visible")?(a.html(b),b?a.slideDown(c):a.slideUp(c)):(a.html(b||"").css("display",b?"block":"none"),c&&c());return this},_typeFn:function(a){var b=Array.prototype.slice.call(arguments);b.shift();b.unshift(this.s.opts);var c=this.s.type[a];if(c)return c.apply(this.s.host,b)}};e.Field.models={};e.Field.defaults={className:"",data:"",def:"",fieldInfo:"",id:"",label:"",labelInfo:"",name:null,type:"text"};e.Field.models.settings={type:null,name:null,classes:null,opts:null,host:null};
e.Field.models.dom={container:null,label:null,labelInfo:null,fieldInfo:null,fieldError:null,fieldMessage:null};e.models={};e.models.displayController={init:function(){},open:function(){},close:function(){}};e.models.fieldType={create:function(){},get:function(){},set:function(){},enable:function(){},disable:function(){}};e.models.settings={ajaxUrl:null,ajax:null,dataSource:null,domTable:null,opts:null,displayController:null,fields:{},order:[],id:-1,displayed:!1,processing:!1,modifier:null,action:null,
idSrc:null};e.models.button={label:null,fn:null,className:null};e.models.formOptions={submitOnReturn:!0,submitOnBlur:!1,blurOnBackground:!0,closeOnComplete:!0,focus:0,buttons:!0,title:!0,message:!0};e.display={};var l=jQuery,g;e.display.lightbox=l.extend(!0,{},e.models.displayController,{init:function(){g._init();return g},open:function(a,b,c){if(g._shown)c&&c();else{g._dte=a;a=g._dom.content;a.children().detach();a.append(b).append(g._dom.close);g._shown=true;g._show(c)}},close:function(a,b){if(g._shown){g._dte=
a;g._hide(b);g._shown=false}else b&&b()},_init:function(){if(!g._ready){var a=g._dom;a.content=l("div.DTED_Lightbox_Content",g._dom.wrapper);a.wrapper.css("opacity",0);a.background.css("opacity",0)}},_show:function(a){var b=g._dom;r.orientation!==m&&l("body").addClass("DTED_Lightbox_Mobile");b.content.css("height","auto");b.wrapper.css({top:-g.conf.offsetAni});l("body").append(g._dom.background).append(g._dom.wrapper);g._heightCalc();b.wrapper.animate({opacity:1,top:0},a);b.background.animate({opacity:1});
b.close.bind("click.DTED_Lightbox",function(){g._dte.close()});b.background.bind("click.DTED_Lightbox",function(){g._dte.blur()});l("div.DTED_Lightbox_Content_Wrapper",b.wrapper).bind("click.DTED_Lightbox",function(a){l(a.target).hasClass("DTED_Lightbox_Content_Wrapper")&&g._dte.blur()});l(r).bind("resize.DTED_Lightbox",function(){g._heightCalc()});g._scrollTop=l("body").scrollTop();a=l("body").children().not(b.background).not(b.wrapper);l("body").append('<div class="DTED_Lightbox_Shown"/>');l("div.DTED_Lightbox_Shown").append(a)},
_heightCalc:function(){var a=g._dom,b=l(r).height()-g.conf.windowPadding*2-l("div.DTE_Header",a.wrapper).outerHeight()-l("div.DTE_Footer",a.wrapper).outerHeight();l("div.DTE_Body_Content",a.wrapper).css("maxHeight",l(r).width()>1024?b:"auto")},_hide:function(a){var b=g._dom;a||(a=function(){});var c=l("div.DTED_Lightbox_Shown");c.children().appendTo("body");c.remove();l("body").removeClass("DTED_Lightbox_Mobile").scrollTop(g._scrollTop);b.wrapper.animate({opacity:0,top:g.conf.offsetAni},function(){l(this).detach();
a()});b.background.animate({opacity:0},function(){l(this).detach()});b.close.unbind("click.DTED_Lightbox");b.background.unbind("click.DTED_Lightbox");l("div.DTED_Lightbox_Content_Wrapper",b.wrapper).unbind("click.DTED_Lightbox");l(r).unbind("resize.DTED_Lightbox")},_dte:null,_ready:!1,_shown:!1,_dom:{wrapper:l('<div class="DTED_Lightbox_Wrapper"><div class="DTED_Lightbox_Container"><div class="DTED_Lightbox_Content_Wrapper"><div class="DTED_Lightbox_Content"></div></div></div></div>'),background:l('<div class="DTED_Lightbox_Background"><div/></div>'),
...
600,a)}):i(f._dom.content).animate({top:0},600,a);i(f._dom.close).bind("click.DTED_Envelope",function(){f._dte.close()});i(f._dom.background).bind("click.DTED_Envelope",function(){f._dte.blur()});i("div.DTED_Lightbox_Content_Wrapper",f._dom.wrapper).bind("click.DTED_Envelope",function(a){i(a.target).hasClass("DTED_Envelope_Content_Wrapper")&&f._dte.blur()});i(r).bind("resize.DTED_Envelope",function(){f._heightCalc()})},_heightCalc:function(){f.conf.heightCalc?f.conf.heightCalc(f._dom.wrapper):i(f._dom.content).children().height();
var a=i(r).height()-f.conf.windowPadding*2-i("div.DTE_Header",f._dom.wrapper).outerHeight()-i("div.DTE_Footer",f._dom.wrapper).outerHeight();i("div.DTE_Body_Content",f._dom.wrapper).css("maxHeight",a);return i(f._dte.dom.wrapper).outerHeight()},_hide:function(a){a||(a=function(){});i(f._dom.content).animate({top:-(f._dom.content.offsetHeight+50)},600,function(){i([f._dom.wrapper,f._dom.background]).fadeOut("normal",a)});i(f._dom.close).unbind("click.DTED_Lightbox");i(f._dom.background).unbind("click.DTED_Lightbox");
i("div.DTED_Lightbox_Content_Wrapper",f._dom.wrapper).unbind("click.DTED_Lightbox");i(r).unbind("resize.DTED_Lightbox")},_findAttachRow:function(){var a=i(f._dte.s.table).DataTable();return f.conf.attach==="head"?a.table().header():f._dte.s.action==="create"?a.table().header():a.row(f._dte.s.modifier).node()},_dte:null,_ready:!1,_cssBackgroundOpacity:1,_dom:{wrapper:i('<div class="DTED_Envelope_Wrapper"><div class="DTED_Envelope_ShadowLeft"></div><div class="DTED_Envelope_ShadowRight"></div><div class="DTED_Envelope_Container"></div></div>')[0],
background:i('<div class="DTED_Envelope_Background"><div/></div>')[0],close:i('<div class="DTED_Envelope_Close">&times;</div>')[0],content:null}});f=e.display.envelope;f.conf={windowPadding:50,heightCalc:null,attach:"row",windowScroll:!0};e.prototype.add=function(a){if(d.isArray(a))for(var b=0,c=a.length;b<c;b++)this.add(a[b]);else{b=a.name;if(!b)throw"Error adding field. The field requires a `name` option";if(this.s.fields[b])throw"Error adding field '"+b+"'. A field already exists with this name";
...
function(){l.remove();d(r).off("resize."+e)})});f.click(function(){k.blur()});j.click(function(){k._close()});this.bubblePosition();l.animate({opacity:1});this._focus(h,c.focus);this._postopen("bubble");return this};e.prototype.bubblePosition=function(){var a=d("div.DTE_Bubble"),b=d("div.DTE_Bubble_Liner"),c=this.s.bubbleNodes,k=0,h=0,e=0;d.each(c,function(a,b){var c=d(b).offset();k+=c.top;h+=c.left;e+=c.left+b.offsetWidth});var k=k/c.length,h=h/c.length,e=e/c.length,c=k,f=(h+e)/2,g=b.outerWidth(),
i=f-g/2,g=i+g,j=d(r).width();a.css({top:c,left:f});g+15>j?b.css("left",15>i?-(i-15):-(g-j+15)):b.css("left",15>i?-(i-15):0);return this};e.prototype.buttons=function(a){var b=this;"_basic"===a?a=[{label:this.i18n[this.s.action].submit,fn:function(){this.submit()}}]:d.isArray(a)||(a=[a]);d(this.dom.buttons).empty();d.each(a,function(a,k){"string"===typeof k&&(k={label:k,fn:function(){this.submit()}});d("<button/>",{"class":k.className||""}).html(k.label||"").click(function(a){a.preventDefault();k.fn&&
...
d.isArray(a)||(a=[a]);var t=this._crudArgs(b,c,e,h);this.s.action="remove";this.s.modifier=a;this.dom.form.style.display="none";this._actionClass();this._event("initRemove",[this._dataSource("node",a),this._dataSource("get",a),a]);this._assembleMain();this._formOptions(t.opts);t.maybeOpen();t=this.s.editOpts;null!==t.focus&&d("button",this.dom.buttons).eq(t.focus).focus();return this};e.prototype.set=function(a,b){var c=this.s.fields;if(!d.isPlainObject(a)){var e={};e[a]=b;a=e}d.each(a,function(a,
b){c[a].set(b)});return this};e.prototype.show=function(a,b){a?d.isArray(a)||(a=[a]):a=this.fields();var c=this.s.fields;d.each(a,function(a,d){c[d].show(b)});return this};e.prototype.submit=function(a,b,c,e){var h=this,f=this.s.fields,t=[],g=0,i=!1;if(this.s.processing||!this.s.action)return this;this._processing(!0);var j=function(){t.length!==g||i||(i=!0,h._submit(a,b,c,e))};this.error();d.each(f,function(a,b){b.inError()&&t.push(a)});d.each(t,function(a,b){f[b].error("",function(){g++;j()})});
j();return this};e.prototype.title=function(a){if(a===m)return d(this.dom.header).children().html();d(this.dom.header).children().html(a);return this};e.prototype.val=function(a,b){return b===m?this.get(a):this.set(a,b)};var j=u.Api.register;j("editor()",function(){return v(this)});j("row.create()",function(a){var b=v(this);b.create(x(b,a,"create"))});j("row().edit()",function(a){var b=v(this);b.edit(this[0][0],x(b,a,"edit"))});j("row().delete()",function(a){var b=v(this);b.remove(this[0][0],x(b,
a,"remove",1))});j("rows().delete()",function(a){var b=v(this);b.remove(this[0],x(b,a,"remove",this[0].length))});j("cell().edit()",function(a){v(this).inline(this[0][0],a)});j("cells().edit()",function(a){v(this).bubble(this[0],a)});e.prototype._constructor=function(a){a=d.extend(!0,{},e.defaults,a);this.s=d.extend(!0,{},e.models.settings,{table:a.domTable||a.table,dbTable:a.dbTable||null,ajaxUrl:a.ajaxUrl,ajax:a.ajax,idSrc:a.idSrc,dataSource:a.domTable||a.table?e.dataSources.dataTable:e.dataSources.html,
...
b].sButtonText=h[b].button})}d.each(a.events,function(a,c){b.on(a,function(){var a=Array.prototype.slice.call(arguments);a.shift();c.apply(b,a)})});var c=this.dom,f=c.wrapper;c.formContent=q("form_content",c.form)[0];c.footer=q("foot",f)[0];c.body=q("body",f)[0];c.bodyContent=q("body_content",f)[0];c.processing=q("processing",f)[0];a.fields&&this.add(a.fields);d(n).on("submit",this.dom.form,function(a){a.preventDefault()});d(n).one("init.dt.dte",function(a,c){b.s.table&&c.nTable===d(b.s.table).get(0)&&
(c._editor=b)});this.s.displayController=e.display[a.display].init(this);this._event("initComplete",[])};e.prototype._actionClass=function(){var a=this.classes.actions,b=this.s.action,c=d(this.dom.wrapper);c.removeClass([a.create,a.edit,a.remove].join(" "));"create"===b?c.addClass(a.create):"edit"===b?c.addClass(a.edit):"remove"===b&&c.addClass(a.remove)};e.prototype._ajax=function(a,b,c){var e={type:"POST",dataType:"json",data:null,success:b,error:c},h=this.s.action,f=this.s.ajax||this.s.ajaxUrl,
h="edit"===h||"remove"===h?this._dataSource("id",this.s.modifier):null;d.isArray(h)&&(h=h.join(","));d.isPlainObject(f)&&f.create&&(f=f[this.s.action]);if(d.isFunction(f)){var g=null,e=null;if(this.s.ajaxUrl){var i=this.s.ajaxUrl;i.create&&(g=i[this.s.action]);-1!==g.indexOf(" ")&&(g=g.split(" "),e=g[0],g=g[1]);g=g.replace(/_id_/,h)}f(e,g,a,b,c)}else"string"===typeof f?-1!==f.indexOf(" ")?(g=f.split(" "),e.type=g[0],e.url=g[1]):e.url=f:e=d.extend({},e,f||{}),e.url=e.url.replace(/_id_/,h),e.data&&
(e.data(a),b=d.isFunction(e.data)?e.data(a):e.data,a=d.isFunction(e.data)&&b?b:d.extend(!0,a,b)),e.data=a,d.ajax(e)};e.prototype._assembleMain=function(){var a=this.dom;d(a.wrapper).prepend(a.header);d(a.footer).append(a.formError).append(a.buttons);d(a.bodyContent).append(a.formInfo).append(a.form)};e.prototype._blur=function(){var a=this.s.editOpts;a.blurOnBackground&&!1!==this._event("preBlur")&&(a.submitOnBlur?this.submit():this._close())};e.prototype._clearDynamicInfo=function(){var a=this.classes.field.error,
b=this.dom.wrapper;d("div."+a,b).removeClass(a);q("msg-error",b).html("").css("display","none");this.error("").message("")};e.prototype._close=function(a){!1!==this._event("preClose")&&(this.s.closeCb&&(this.s.closeCb(a),this.s.closeCb=null),this.s.closeIcb&&(this.s.closeIcb(),this.s.closeIcb=null),this.s.displayed=!1,this._event("close"))};e.prototype._closeReg=function(a){this.s.closeCb=a};e.prototype._crudArgs=function(a,b,c,e){var h=this,f,g,i;d.isPlainObject(a)||("boolean"===typeof a?(i=a,a=
b):(f=a,g=b,i=c,a=e));i===m&&(i=!0);f&&h.title(f);g&&h.buttons(g);return{opts:d.extend({},this.s.formOptions.main,a),maybeOpen:function(){i&&h.open()}}};e.prototype._dataSource=function(a){var b=Array.prototype.slice.call(arguments);b.shift();var c=this.s.dataSource[a];if(c)return c.apply(this,b)};e.prototype._displayReorder=function(a){var b=d(this.dom.formContent),c=this.s.fields,a=a||this.s.order;b.children().detach();d.each(a,function(a,d){b.append(d instanceof e.Field?d.node():c[d].node())})};
e.prototype._edit=function(a,b){var c=this.s.fields,e=this._dataSource("get",a,c);this.s.modifier=a;this.s.action="edit";this.dom.form.style.display="block";this._actionClass();d.each(c,function(a,b){var c=b.valFromData(e);b.set(c!==m?c:b.def())});this._event("initEdit",[this._dataSource("node",a),e,a,b])};e.prototype._event=function(a,b){b||(b=[]);if(d.isArray(a))for(var c=0,e=a.length;c<e;c++)this._event(a[c],b);else return c=d.Event(a),d(this).triggerHandler(c,b),c.result};e.prototype._eventName=
function(a){for(var b=a.split(" "),c=0,d=b.length;c<d;c++){var a=b[c],e=a.match(/^on([A-Z])/);e&&(a=e[1].toLowerCase()+a.substring(3));b[c]=a}return b.join(" ")};e.prototype._focus=function(a,b){"number"===typeof b?a[b].focus():b&&(0===b.indexOf("jq:")?d("div.DTE "+b.replace(/^jq:/,"")).focus():this.s.fields[b].focus())};e.prototype._formOptions=function(a){var b=this,c=w++,e=".dteInline"+c;this.s.editOpts=a;this.s.editCount=c;"string"===typeof a.title&&(this.title(a.title),a.title=!0);"string"===
typeof a.message&&(this.message(a.message),a.message=!0);"boolean"!==typeof a.buttons&&(this.buttons(a.buttons),a.buttons=!0);d(n).on("keyup"+e,function(c){var e=d(n.activeElement),f=e[0].nodeName.toLowerCase(),k=d(e).attr("type"),f=f==="input"&&d.inArray(k,["color","date","datetime","datetime-local","email","month","number","password","range","search","tel","text","time","url","week"])!==-1;if(b.s.displayed&&a.submitOnReturn&&c.keyCode===13&&f){c.preventDefault();b.submit()}else if(c.keyCode===27){c.preventDefault();
b._close()}else e.parents(".DTE_Form_Buttons").length&&(c.keyCode===37?e.prev("button").focus():c.keyCode===39&&e.next("button").focus())});this.s.closeIcb=function(){d(n).off("keyup"+e)};return e};e.prototype._killInline=function(a){return d("div.DTE_Inline").length?(this.off("close.killInline").one("close.killInline",a).blur(),!0):!1};e.prototype._message=function(a,b,c){!c&&this.s.displayed?"slide"===b?d(a).slideUp():d(a).fadeOut():c?this.s.displayed?"slide"===b?d(a).html(c).slideDown():d(a).html(c).fadeIn():
(d(a).html(c),a.style.display="block"):a.style.display="none"};e.prototype._postopen=function(a){this._event("open",[a]);return!0};e.prototype._preopen=function(a){if(!1===this._event("preOpen",[a]))return!1;this.s.displayed=a;return!0};e.prototype._processing=function(a){var b=d(this.dom.wrapper),c=this.dom.processing.style,e=this.classes.processing.active;a?(c.display="block",b.addClass(e)):(c.display="none",b.removeClass(e));this.s.processing=a;this._event("processing",[a])};e.prototype._submit=
function(a,b,c,e){var h=this,f=u.ext.oApi._fnSetObjectDataFn,g={},i=this.s.fields,j=this.s.action,l=this.s.editCount,o=this.s.modifier,n={action:this.s.action,data:{}};this.s.dbTable&&(n.table=this.s.dbTable);if("create"===j||"edit"===j)d.each(i,function(a,b){f(b.dataSrc())(n.data,b.get())}),d.extend(!0,g,n.data);if("edit"===j||"remove"===j)n.id=this._dataSource("id",o);c&&c(n);!1===this._event("preSubmit",[n,j])?this._processing(!1):this._ajax(n,function(c){h._event("postSubmit",[c,n,j]);if(!c.error)c.error=
"";if(!c.fieldErrors)c.fieldErrors=[];if(c.error||c.fieldErrors.length){h.error(c.error);d.each(c.fieldErrors,function(a,b){var c=i[b.name];c.error(b.status||"Error");if(a===0){d(h.dom.bodyContent,h.s.wrapper).animate({scrollTop:d(c.node()).position().top},500);c.focus()}});b&&b.call(h,c)}else{var s=c.row!==m?c.row:g;h._event("setData",[c,s,j]);if(j==="create"){h.s.idSrc===null&&c.id?s.DT_RowId=c.id:c.id&&f(h.s.idSrc)(s,c.id);h._event("preCreate",[c,s]);h._dataSource("create",i,s);h._event(["create",
"postCreate"],[c,s])}else if(j==="edit"){h._event("preEdit",[c,s]);h._dataSource("edit",o,i,s);h._event(["edit","postEdit"],[c,s])}else if(j==="remove"){h._event("preRemove",[c]);h._dataSource("remove",o,i);h._event(["remove","postRemove"],[c])}if(l===h.s.editCount){h.s.action=null;h.s.editOpts.closeOnComplete&&(e===m||e)&&h._close(true)}a&&a.call(h,c);h._event(["submitSuccess","submitComplete"],[c,s])}h._processing(false)},function(a,c,d){h._event("postSubmit",[a,c,d,n]);h.error(h.i18n.error.system);
h._processing(false);b&&b.call(h,a,c,d);h._event(["submitError","submitComplete"],[a,c,d,n])})};e.defaults={table:null,ajaxUrl:null,fields:[],display:"lightbox",ajax:null,idSrc:null,events:{},i18n:{create:{button:"New",title:"Create new entry",submit:"Create"},edit:{button:"Edit",title:"Edit entry",submit:"Update"},remove:{button:"Delete",title:"Delete",submit:"Delete",confirm:{_:"Are you sure you wish to delete %d rows?",1:"Are you sure you wish to delete 1 row?"}},error:{system:"An error has occurred - Please contact the system administrator"}},
formOptions:{bubble:d.extend({},e.models.formOptions,{title:!1,message:!1,buttons:"_basic"}),inline:d.extend({},e.models.formOptions,{buttons:!1}),main:d.extend({},e.models.formOptions)}};var z=function(a,b,c){d.each(b,function(a,b){d('[data-editor-field="'+b.dataSrc()+'"]').html(b.valFromData(c))})},j=e.dataSources={},A=function(a){a=d(a);setTimeout(function(){a.addClass("highlight");setTimeout(function(){a.addClass("noHighlight").removeClass("highlight");setTimeout(function(){a.removeClass("noHighlight")},
550)},500)},20)},B=function(a,b,c){if(d.isArray(b))return d.map(b,function(b){return B(a,b,c)});var e=u.ext.oApi,b=d(a).DataTable().row(b);return null===c?b.node().id:e._fnGetObjectDataFn(c)(b.data())};j.dataTable={id:function(a){return B(this.s.table,a,this.s.idSrc)},get:function(a){var b=d(this.s.table).DataTable().rows(a).data().toArray();return d.isArray(a)?b:b[0]},node:function(a){var b=d(this.s.table).DataTable().rows(a).nodes().toArray();return d.isArray(a)?b:b[0]},individual:function(a,b,
c){var e=d(this.s.table).DataTable(),a=e.cell(a),f=a.index(),g;if(c&&(g=b?c[b]:c[e.settings()[0].aoColumns[f.column].mData],!g))throw"Unable to automatically determine field from source. Please specify the field name";return{node:a.node(),edit:f.row,field:g}},create:function(a,b){var c=d(this.s.table).DataTable();if(c.settings()[0].oFeatures.bServerSide)c.draw();else if(null!==b){var e=c.row.add(b);c.draw();A(e.node())}},edit:function(a,b,c){b=d(this.s.table).DataTable();b.settings()[0].oFeatures.bServerSide?
b.draw(!1):(a=b.row(a),null===c?a.remove().draw(!1):(a.data(c).draw(!1),A(a.node())))},remove:function(a){var b=d(this.s.table).DataTable();b.settings()[0].oFeatures.bServerSide?b.draw():b.rows(a).remove().draw()}};j.html={id:function(a){return a},initField:function(a){var b=d('[data-editor-label="'+(a.data||a.name)+'"]');!a.label&&b.length&&(a.label=b.html())},get:function(a,b){var c={};d.each(b,function(a,b){var e=d('[data-editor-field="'+b.dataSrc()+'"]').html();b.valToData(c,e)});return c},node:function(){return n},
individual:function(a,b,c){"string"===typeof a?(b=a,d('[data-editor-field="'+b+'"]')):b=d(a).attr("data-editor-field");a=d('[data-editor-field="'+b+'"]');return{node:a[0],edit:a.parents("[data-editor-id]").data("editor-id"),field:c?c[b]:null}},create:function(a,b){z(null,a,b)},edit:function(a,b,c){z(a,b,c)}};j.js={id:function(a){return a},get:function(a,b){var c={};d.each(b,function(a,b){b.valToData(c,b.val())});return c},node:function(){return n}};e.classes={wrapper:"DTE",processing:{indicator:"DTE_Processing_Indicator",
