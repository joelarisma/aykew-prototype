...
<head>
    ...
    <script>
    function dt_disable_scroll(e) {
        e.preventDefault();
    }
    document.addEventListener('touchmove', dt_disable_scroll, false);
    </script>
</head>
<body>
<div class="games-header">
</div>
<div class="games-container overthrow" id="body_login">
...
<footer class="games-footer">
    <div class="footer_sec clearfix">
        <div class="copyright">
            <p><?php printf("Copyright &copy; %d Infinite Mind, LC. All rights reserved.",date("Y"))?></p>
        </div>
    </div>
</footer>
<script>
